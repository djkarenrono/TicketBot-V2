            ...
            try {
                ...
                for (const [, category] of factionCategories) {
                    ...
                    await factionTextChannel.send({
                        content: `${rolePing}📢 **Staff Announcement** — Posted by ${message.author} in <#${message.channel.id}>\n${message.content}`,
                ...
                if (survivorChannel) {
                    await survivorChannel.send({
                        content: `<@&${SURVIVOR_ROLE_ID}> 📢 **Staff Announcement** — Posted by ${message.author} in <#${message.channel.id}>\n${message.content}`,
                        files: attachmentUrls
